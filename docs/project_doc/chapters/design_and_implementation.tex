...
\begin{lstlisting}[label=lst:morse_demod_method, caption=The demodulate method of the new Morse demodulator, language=java]
        switch (this.state) {
            case INIT:
                if (amDemod) {
...
% TODO screenshot
% TODO irgendwo Logging funktionalität dokumentieren
