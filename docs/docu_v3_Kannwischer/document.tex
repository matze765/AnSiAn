...
\newcommand{\myTime}{\formatdate{16}{03}{2017}\xspace}
...
\include{chap/01intro}
\include{chap/02design}
\include{chap/03progress}
\include{chap/04implementation}
\include{chap/05conclusion}
